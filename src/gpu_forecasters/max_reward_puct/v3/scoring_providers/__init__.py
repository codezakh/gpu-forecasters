...
Existing v2 concretes (e.g. ``gpu_forecasters.max_reward_puct.v2.
...
surrogate concretes in ``gpu_forecasters.landscape_map.v2`` are async-
...
from gpu_forecasters.max_reward_puct.v3.scoring_providers.coroutine_adapter import (
